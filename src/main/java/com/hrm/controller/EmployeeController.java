...
public class EmployeeController {
	...
	public String updateEmployee(@RequestParam("street") String street, @RequestParam("city") String city,
			@RequestParam("state") String state, @RequestParam("zip") int zip, @RequestParam("country") String country,@PathVariable("id") int id, @ModelAttribute(value = "employee") Employee employee) {
